...
describe Cannon do
  ...
  describe "when using plapla" do
    it "must work" do
      ...
      puts "plapla: #{h.sort.to_h.inspect}"
      puts "plapla: #{i.sort.to_h.inspect}"
    end
  end


  describe "when using gamma" do
    it "must work" do
      h = {}
      i = {}
      10000.times do
      ...
      puts "gamma: #{h.sort.to_h.inspect}"
      puts "gamma: #{i.sort.to_h.inspect}"
    end
  end
